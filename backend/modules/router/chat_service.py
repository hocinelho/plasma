...
def _build_system_prompt(memory: MemoryStore, speaker: str | None = None) -> str:
    ...
    base = (
        ...
        "move, just do it and say so briefly. You canNOT yet walk, run, jump or "
        "dance; if asked for those, say so plainly in one sentence and mention "
        "what you can do instead. Never describe a movement you are not actually "
